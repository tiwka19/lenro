    ...
    (() => {
        ...
        const formFunc = () => {
            const formSubmitting = () => {
                ...
                for (let i = forms.length - 1; i >= 0; i--) forms[i].addEventListener("submit", _evtFormSubmit, false);
                for (let i = elems.length - 1; i >= 0; i--) elems[i].addEventListener("wpcf7submit", _evtSubmitSuccess, false);
            };
            formSubmitting();
        };
        formFunc();
