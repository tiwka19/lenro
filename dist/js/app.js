 ...
 */
            (function(root, factory) {
                ...
                Toastify.lib = Toastify.prototype = {
                    ...
                    init: function(options) {
                        ...
                        this.options.duration = 0 === options.duration ? 0 : options.duration || Toastify.defaults.duration;
                        ...
                        this.options.gravity = "bottom" === options.gravity ? "toastify-bottom" : Toastify.defaults.gravity;
                        ...
                        this.options.stopOnFocus = void 0 === options.stopOnFocus ? Toastify.defaults.stopOnFocus : options.stopOnFocus;
                        this.options.onClick = options.onClick || Toastify.defaults.onClick;
                        this.options.offset = options.offset || Toastify.defaults.offset;
                        this.options.escapeMarkup = void 0 !== options.escapeMarkup ? options.escapeMarkup : Toastify.defaults.escapeMarkup;
                    ...
                    buildToast: function() {
                        ...
                        if (!!this.options.position) divElement.className += " toastify-" + this.options.position; else if (true === this.options.positionLeft) {
                        ...
                        if (this.options.node && this.options.node.nodeType === Node.ELEMENT_NODE) divElement.appendChild(this.options.node); else {
                            ...
                            if ("" !== this.options.avatar) {
                                ...
                                if ("left" == this.options.position || true === this.options.positionLeft) divElement.appendChild(avatarElement); else divElement.insertAdjacentElement("afterbegin", avatarElement);
                            }
                        }
                        if (true === this.options.close) {
                            ...
                            if (("left" == this.options.position || true === this.options.positionLeft) && width > 360) divElement.insertAdjacentElement("afterbegin", closeElement); else divElement.appendChild(closeElement);
                        }
                        ...
                        if ("undefined" !== typeof this.options.destination) divElement.addEventListener("click", function(event) {
                            event.stopPropagation();
                            if (true === this.options.newWindow) window.open(this.options.destination, "_blank"); else window.location = this.options.destination;
                        }.bind(this));
                        if ("function" === typeof this.options.onClick && "undefined" === typeof this.options.destination) divElement.addEventListener("click", function(event) {
                            event.stopPropagation();
                        ...
                        if ("object" === typeof this.options.offset) {
                            ...
                            var xOffset = "left" == this.options.position ? x : "-" + x;
                            var yOffset = "toastify-top" == this.options.gravity ? y : "-" + y;
                    ...
                    showToast: function() {
                        ...
                        var rootElement;
                        if ("string" === typeof this.options.selector) rootElement = document.getElementById(this.options.selector); else if (this.options.selector instanceof HTMLElement || "undefined" !== typeof ShadowRoot && this.options.selector instanceof ShadowRoot) rootElement = this.options.selector; else rootElement = document.body;
                ...
                Toastify.reposition = function() {
                    ...
                    for (var i = 0; i < allToasts.length; i++) {
                        if (true === containsClass(allToasts[i], "toastify-top")) classUsed = "toastify-top"; else classUsed = "toastify-bottom";
                        ...
                        } else if (true === containsClass(allToasts[i], "toastify-left")) {
                ...
                function containsClass(elem, yourClass) {
                    if (!elem || "string" !== typeof yourClass) return false; else if (elem.className && elem.className.trim().split(/\s+/gi).indexOf(yourClass) > -1) return true; else return false;
                }
    ...
    (() => {
        ...
        function tabs() {
            ...
            if (tabs.length > 0) {
                ...
                tabs.forEach(((tabsBlock, index) => {
                    ...
                    if (tabsBlock.classList.contains("tabs-catalog")) tabsBlock.addEventListener("mouseover", setTabsAction); else tabsBlock.addEventListener("click", setTabsAction);
                    initTabs(tabsBlock);
                }));
        ...
        function initSliders() {
            ...
            if (document.querySelector(".related__slider")) new core(".related__slider", {
                modules: [ Navigation, Autoplay ],
                observer: true,
                observeParents: true,
                spaceBetween: 15,
            ...
            if (document.querySelector(".cert__slider")) new core(".cert__slider", {
        ...
        inputs.forEach((input => {
            input.addEventListener("input", (e => {
                ...
                let result;
                if (input.value.includes("+8") || "8" === input.value[0]) result = ""; else result = "+";
        ...
        const maps = () => {
            ...
            function init() {
                ...
                let ptPlacemark1 = new ymaps.Placemark([ 60.05909, 30.335029 ], {
                ...
                let ptPlacemark2 = new ymaps.Placemark([ 60.043929, 30.489818 ], {
        ...
        function scrollFunction() {
            if (document.body.scrollTop > 100 || document.documentElement.scrollTop > 100) scrollToTopButton.classList.add("visible"); else scrollToTopButton.classList.remove("visible");
        }
